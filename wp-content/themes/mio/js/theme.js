				...
				jQuery( 'form.product_form_ajax, .wpsc-add-to-cart-button-form' ).on( 'submit', function() {
					...
					if(file_upload_elements.length > 0) {
						...
						var success = function( response ) {console.log(response);
							if ( response.fancy_notification ) {  console.log(response.fancy_notification);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////				
				...
				// check if variation is selected, if not bounce box
					...
					jQuery('.wpsc_buy_button', this).click(function(){
						...
						if(jQuery(this).parents('form:first').find('select.wpsc_select_variation_ajax[value=0]:first').length) {
							return false; 
						}
					});
				});	
