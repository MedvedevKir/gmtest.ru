...
<form id="main_anket_form" name="main_anket_form" action="" class="hide">
    <div class="addition_questions">
        ...
        <div class="row div_succes">
            <h4>
                Какой вопрос стал для вас самым важным и первостепенным сразу после того, как возникла потребность в глюкометре?
                <img class="succes hide" src="<?php echo plugins_url(); ?>/questionnaire/assets/css/images/succes.png" alt="">
            </h4>
            <fieldset class="question_2 prize_places custom_fieldset">
                ...
                <div class="row answer_row">
                    <div class="col-md-11 col-sm-11 answer">
                        <ul>
                            <li class="answer_li">
                                Как правильно выбрать глюкометр и понять какой из глюкометров лучше?
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-1 col-sm-1 answer">
        ...
        <div class="row">
            ...
            <fieldset class="question_3 validate_checkbox custom_fieldset">
                <div class="row">
                    ...
                    <div class="col-md-11 col-sm-11">
                        <label class="label_checkbox">Решили спросить у своего врача</label><br />
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-1 col-sm-1">
                    ...
                    <div class="col-md-11 col-sm-11">
                        <label class="label_checkbox">Решили обратиться за помощью по контактам в рекламных объявлениях, размещенных в больнице рядом с кабинетом врача</label><br />
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-1 col-sm-1">
                    ...
                    <div class="col-md-5 col-sm-5">
                        <label class="label_checkbox">Решили позвонить в медицинскую справочную</label><br />
                    </div>
                    <div class="col-md-6 col-sm-6">
                        <input type="text" name="medical_referral" id="medical_referral" style="margin-left: 45px;
                        margin-top: -1px;" class="hide other_answer">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-1 col-sm-1">
                    ...
                    <div class="col-md-11 col-sm-11">
                        <label class="label_checkbox">Решили искать информацию в интернете</label><br />
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-1 col-sm-1">
                        <input type="checkbox" name="q3_a5" class="label_checkbox"> 
                    </div>
                    <div class="col-md-11 col-sm-11">
                        <label class="label_checkbox">Решили спросить у знакомых</label><br />
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-1 col-sm-1">
                        <input type="checkbox" name="q3_a6" class="label_checkbox other"> 
                    </div>
                    <div class="col-md-11 col-sm-11">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <textarea class="long hide other_answer" name="q3_a7"></textarea>
                    </div>
                </div>
            </fieldset>
        </div>
        <div class="row div_succes">
            ...
            <fieldset class="question_34 prize_places custom_fieldset">
                <div class="row answer_row">
                    <div class="col-md-11 col-sm-11 answer">
                        <ul>
                            <li class="answer_li">
                                Чтобы у глюкометра была высокая точность измерения
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-1 col-sm-1 answer">
                        <select class="answer" value="" name="q34_a1">
                            <option value="">...</option>
                            <option value="1">1</option>
                        </select>
                    </div>
                ...
                <div class="row answer_row">
                    ...
                    <div class="col-md-1 col-sm-1 answer">
                        <select class="answer" value="" name="q34_a2">
                            <option value="">...</option>
                            <option value="1">1</option>
                        </select>
                    </div>
                ...
                <div class="row answer_row">
                    ...
                    <div class="col-md-1 col-sm-1 answer">
                        <select class="answer" value="" name="q34_a3">
                            <option value="">...</option>
                            <option value="1">1</option>
                        </select>
                    </div>
                ...
                <div class="row answer_row">
                    ...
                    <div class="col-md-1 col-sm-1 answer">
                        <select class="answer" value="" name="q34_a4">
                            <option value="">...</option>
                            <option value="1">1</option>
                        </select>
                    </div>
                ...
                <div class="row answer_row">
                    ...
                    <div class="col-md-1 col-sm-1 answer">
                        <select class="answer" value="" name="q34_a5">
                            <option value="">...</option>
                            <option value="1">1</option>
                        </select>
                    </div>
                ...
                <div class="row answer_row">
                    <div class="col-md-11 col-sm-11 answer">
                        <ul>
                            <li class="answer_li">
                                Чтобы процедура получения образца крови была безболезненной
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-1 col-sm-1 answer">
                        <select class="answer" value="" name="q34_a6">
                            <option value="">...</option>
                            <option value="1">1</option>
                        </select>
                    </div>
                ...
                <div class="row answer_row">
                    ...
                    <div class="col-md-1 col-sm-1 answer">
                        <select class="answer other" value="" name="q34_a7">
                            <option value="">...</option>
                            <option value="1">1</option>
                        </select>
                    </div>
                ...
                <div class="row answer_row">
                    <div class="col-md-12 col-sm-12 answer">
                        <textarea class="long other_answer hide" name="q34_a8"></textarea>
                    </div>
                </div>
            </fieldset>
        </div>
            ...
            <fieldset class="question_5 prize_places custom_fieldset">
                ...
                <div class="row answer_row">
                    <div class="col-md-11 col-sm-11 answer">
                        <ul>
                            <li class="answer_li">
                                Чтобы продавец проверил точность измерения глюкометра. И я смог(ла) убедиться в ней во время покупки
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-1 col-sm-1 answer">
        ...
        <div class="row div_succes">
            <h4>
                По каким критериям вы будете выбирать магазин для дальнейшей покупки тест-полосок и расходных материалов к своему глюкометру? Что вам необходимо для того, чтобы совершать свои покупки только в этом магазине?
                <img class="succes hide" src="<?php echo plugins_url(); ?>/questionnaire/assets/css/images/succes.png" alt="">
            </h4>
            <fieldset class="question_6 prize_places custom_fieldset">
                <div class="row answer_row">
                    <div class="col-md-11 col-sm-11 answer">
                        <ul>
                            <li class="answer_li">
                                Постоянное (бесперебойное) наличие тест-полосок и расходных материалов в магазине
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-1 col-sm-1 answer">
        ...
        <div class="row">
            <h4>
                Чего на ваш взгляд не хватает в магазинах/аптеках, которые продают и обслуживают глюкометры? Появлению какой услуги или сервиса, вы сейчас были бы рады?
                <img class="succes hide" src="<?php echo plugins_url(); ?>/questionnaire/assets/css/images/succes.png" alt="">
            </h4>
        ...
        <div class="row">
            <h4>
                Что для вас является идеальным образом магазина по продаже глюкометров и тест-полосок?
                <img class="succes hide" src="<?php echo plugins_url(); ?>/questionnaire/assets/css/images/succes.png" alt="">
            </h4>
            <fieldset class="question_10">
