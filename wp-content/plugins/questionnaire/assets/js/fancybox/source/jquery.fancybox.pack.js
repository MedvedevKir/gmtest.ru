    ...
    f.extend(b, {
        ...
        defaults: {
            ...
            tpl: {
                ...
                closeBtn: '<a title="Свернуть" class="fancybox-item fancybox-close" href="javascript:;"></a>',
        ...
        _afterZoomIn: function () {
            ...
            a && (b.isOpen = b.isOpened = !0, b.wrap.css("overflow", "visible").addClass("fancybox-opened"), b.update(), (a.closeClick || a.nextClick && 1 < b.group.length) && b.inner.css("cursor", "pointer").bind("click.fb", function (d) {
                ...
                fancybox_opened_left = $('.fancybox-opened').css('left');
	            $('.fancybox-overlay').css('opacity', '0');
                $('.fancybox-overlay').css('z-index', '-8010');
                $('.fancybox-opened').css('opacity', '0');
                $('.fancybox-opened').css('z-index', '-8010');
